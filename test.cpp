...
int main() {
    ...
    const std::vector<std::pair<std::vector<uint8_t>, uint8_t>>  dataset_test = readDataset("dataset/mnist_test.csv");
    ...
    const std::vector<std::vector<double>> weights = readWeights("weights.csv");
